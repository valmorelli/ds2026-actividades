...
function validarFormulario(): Libro | null {
    const nom = (document.querySelector('#nombre') as HTMLInputElement).value;
    const aut = (document.querySelector('#autor') as HTMLInputElement).value;
    const pre = parseFloat((document.querySelector('#precio') as HTMLInputElement).value);
    const dis = (document.querySelector('#disponible') as HTMLInputElement).checked;
    const gen = (document.querySelector('#genero') as HTMLInputElement).value;
...
document.querySelector('#botonAgregar')?.addEventListener('click', () => {
    ...
    if (!nuevo) {
        ...
        (document.querySelector('#genero') as HTMLInputElement).value = "";
    }
});
